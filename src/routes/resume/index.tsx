...
const Resume: FC<JSX.IntrinsicElements["main"]> = () => {
  return (
    <main
      className="relative page dark:bg-dark-2 bg-gray-50 p-5 pt-0 pb-20"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-[1200px] bg-white m-auto rounded-3xl overflow-hidden shadow-2xl dark:bg-dark-3 border border-slate-200 dark:border-dark-3">
            ...
            <div className="p-8 flex flex-row justify-between flex-1">
              ...
              <div className="lg:flex items-start flex-col hidden">
                <a
                  ...
                  target="_blank"
                >
                  <IoLogoLinkedin size={26} color="#fff" />{" "}
                  {cv.contact.linkedin}
                </a>
                <a
